# In the terminal, type "pip install SpeechRecognition pyttsx3 nltk google-generativeai python-dotenv openpyxl matplotlib"
# Download necessary files, such as the following: '.env','emotions_words.xlsx'
...
def display_emotion(text):
    ...
    ax.text(0.5, 0.4, corrected_sentence.upper(), color=theme_color, fontsize=22, ha="center", fontweight="bold")
